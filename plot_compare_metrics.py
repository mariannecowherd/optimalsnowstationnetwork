...
ax5 = fig.add_subplot(422, projection=proj)
ax6 = fig.add_subplot(424, projection=proj)
ax7 = fig.add_subplot(426, projection=proj)
...
im = meaniter[1,:,:].plot(ax=ax2, add_colorbar=False, cmap=cmap, vmin=0, vmax=1, transform=transf, levels=levels)
...
stditer[0,:,:].plot(ax=ax5, add_colorbar=False, cmap=cmap, vmin=0, vmax=1, transform=transf, levels=levels)
stditer[0,:,:].plot(ax=ax6, add_colorbar=False, cmap=cmap, vmin=0, vmax=1, transform=transf, levels=levels)
#stditer[0,:,:].plot(ax=ax7, add_colorbar=False, cmap=cmap, vmin=0, vmax=1, transform=transf, levels=levels)
#stditer[0,:,:].plot(ax=ax8, add_colorbar=False, cmap=cmap, vmin=0, vmax=1, transform=transf, levels=levels)
